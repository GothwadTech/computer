...
import com.gothwad.computer.databinding.DialogSetupWizardBinding
        ...
        when (currentStep) {
            ...
            2 -> {
                ...
                if (notifGranted) {
                    ...
                    binding.tvStepBody.text = "Gothwad Computer can show active TV notifications and detect background OEM ads. Enable notification listener access to activate this feature."
                    binding.tvStepSecondary.visibility = View.GONE
                    binding.layoutActionArea.visibility = View.VISIBLE
