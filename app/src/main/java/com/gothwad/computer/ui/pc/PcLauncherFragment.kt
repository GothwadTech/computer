package com.gothwad.computer.ui.pc
...
import com.gothwad.computer.GothwadApplication
...
import com.gothwad.computer.databinding.LayoutPcContextMenuBinding
import com.gothwad.computer.service.NotificationManagerBridge
import com.gothwad.computer.ui.AppIcons
import com.gothwad.computer.ui.WALLPAPERS
...
import com.gothwad.computer.ui.view.SmoothOutlineProvider
...
class PcLauncherFragment : Fragment() {
    ...
    private fun showUnpinPopup(app: AppEntry, anchor: View) {
        ...
        val container = android.widget.LinearLayout(context).apply {
            ...
            background = androidx.core.content.ContextCompat.getDrawable(context, com.gothwad.computer.R.drawable.bg_pc_context_menu)
            elevation = 16f
    ...
    private fun handleAppLaunch(app: AppEntry, skipLock: Boolean = false) {
        ...
        if (app.pkg == "com.gothwad.computer.files") {
            openFileManagerWindow()
            return
        }
    ...
    private suspend fun loadApps() {
        ...
        if (scanned.none { it.pkg == "com.gothwad.computer.webapp" }) {
            scanned.add(
                1,
                AppEntry(
