package com.gothwad.computer.service
...
import com.gothwad.computer.data.AccessibilityStateTracker
import com.gothwad.computer.data.ProcessHelper
 ...
 * 1) The main process (com.gothwad.computer) is alive and healthy. If dead or in an ANR condition,
...
class LauncherWatchdogService : Service() {
    ...
    private fun checkMainProcessHealth() {
        ...
        val targetProcessName = packageName // "com.gothwad.computer"
    ...
    companion object {
        ...
        const val ACTION_ACCESSIBILITY_DISABLED_ALERT = "com.gothwad.computer.ACCESSIBILITY_DISABLED_ALERT"
