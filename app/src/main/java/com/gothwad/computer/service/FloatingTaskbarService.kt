...
import com.gothwad.computer.ui.view.SmoothCornerDrawable
...
class FloatingTaskbarService : Service() {
    ...
    companion object {
        const val ACTION_TOGGLE_MENU = "com.gothwad.computer.TOGGLE_MENU"
        const val ACTION_STOP_SERVICE = "com.gothwad.computer.STOP_SERVICE"
