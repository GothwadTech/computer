...
data class LauncherConfig(
    ...
    // ----- PC Emulator Extended Settings -----
    val pcShowTaskbarSearch: Boolean = true,
    val pcShowTaskbarClockSeconds: Boolean = false,
    val pcShowTaskbarWidgets: Boolean = true,
    val pcShowTaskbarTaskView: Boolean = true,
    val pcDoubleClickToOpen: Boolean = false,
    val pcWindowSnapping: Boolean = true,
    val pcMaxWindows: Int = 8,
    val pcSoundEnabled: Boolean = true,
    val pcVolumeLevel: Int = 80,
    val pcStartMenuClassic: Boolean = false,
    val pcShowRecentInStart: Boolean = true,
    val pcShowMostUsedInStart: Boolean = true,
    val pcShowSystemIconsOnDesktop: Boolean = true,
    val pcAutoArrangeDesktop: Boolean = true,
    val pcUserName: String = "User",
    val pcDeviceName: String = "Gothwad-PC",
    val pcCursorStyle: Int = 0,
    val pcCursorScale: Float = 1.0f,
    val pcSearchEngine: String = "Google",
    val pcStartupApps: Set<String> = emptySet(),
    val pcPerformanceMode: Boolean = true,
    val pcShowFpsOverlay: Boolean = false,
    val pcHighContrast: Boolean = false,
    val pcAnimationSpeed: Float = 1.0f,
    val pcKeepScreenOn: Boolean = false,
    val pcThemeMode: Int = 0,
    val pcUpdatesPaused: Boolean = false,
    val pcTouchGamepad: Boolean = false,
    val pcDateFormat: String = "DD/MM/YYYY",
    val pcLanguage: String = "en",
